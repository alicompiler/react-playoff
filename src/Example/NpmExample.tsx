import { PlayOff } from "react-playoff";
import type { Match, PlayOffLayout, RenderMatchFunc, Rounds } from "react-playoff";
...
export const NpmExample = ({ layout, renderPaths = true, defaultMatch }: { layout: PlayOffLayout, renderPaths?: boolean, defaultMatch?: boolean }) => {
    ...
    return (
        <div data-testid="npm-example" style={{
